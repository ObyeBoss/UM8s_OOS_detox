...
set_permissions() {
  ...
  # set_perm $MODPATH/data/oplus/os/battery/not_restrict.xml 1000 1000 0600 u:object_r:os_data_file:s0
  # set_perm $MODPATH/data/oplus/os/battery/notify_whitelist.xml 1000 1000 0600 u:object_r:os_data_file:s0
  # set_perm $MODPATH/data/oplus/os/battery/startinfo_white.xml 1000 1000 0600 u:object_r:os_data_file:s0

  # set_perm $MODPATH/multimedia_display_brightness_config.xml 0 0 0644 u:object_r:vendor_file:s0
  # set_perm $MODPATH/multimedia_display_feature_config.xml 0 0 0644 u:object_r:vendor_file:s0
}
SKIPUNZIP=1
