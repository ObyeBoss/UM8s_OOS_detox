...
sleep 15; rm -rf /data/tombstones/*; rm -rf /mnt/oplus/op2/media/log/*; cmd wifi force-country-code enabled 00; cmd wifi set-verbose-logging disabled; echo "1" > /proc/sys/net/ipv4/tcp_window_scaling; echo "900" > /proc/sys/net/ipv4/tcp_max_reordering; echo "bbr" > /proc/sys/net/ipv4/tcp_congestion_control; echo "0" > /proc/sys/net/ipv4/tcp_slow_start_after_idle; echo "0" > /proc/sys/net/ipv4/tcp_no_metrics_save
(
